...
<div style="margin-left: 20px; margin-right: 20px;">
  ...
  <div style="text-align: center;">
      <figure style="display: inline-block; width: 320px; margin: 10px; vertical-align: top;">
        <img src="../images/resolution_figure.png" alt="Resolution figure amp 0.25" style="width: 300px;">
      ...
      <figure style="display: inline-block; width: 320px; margin: 10px; vertical-align: top;">
        <img src="../images/resolution_figure2.png" alt="Resolution figure amp 1" style="width: 300px;">
